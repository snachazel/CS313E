...
def bunnyEas(bunnies):
    if bunnies == 0:
        return 0
    else:
        return 2 + bunnyEas(bunnies - 1)
...
def stringClean(str):
    if len(str) == 0:
        ...
        return str[0:2] + stringClean(str[2:])
...
def parenBit(str):
    if len(str) < 2:
        ...
        return parenBit(str[1: len(str) - 2])
    elif str[0] == "(" and str[-1] == ")":
...
def nestParen(str):
    if str == "":
        return False
    elif str[len(str) - 1] == ")" and str[0] == "(" :
        return nestParen(str[1:len(str) - 2])
    elif str[len(str) - 1] != ")" or str[0] != "(" :
        return False
